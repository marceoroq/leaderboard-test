...
export default function Home() {
  return (
    <main className="flex flex-col row-start-2 justify-items-center h-screen p-8 pb-20 sm:p-20 font-mono items-center sm:items-start">
      <div className="flex flex-col w-full max-w-3xl h-full mx-auto p-6">
        ...
        <TabProvider defaultTab="tab1">
          ...
          <TabPanels>
            <TabPanel className="flex flex-col h-full" id="tab1">
              <div className="p-4 h-full rounded-lg bg-auburn overflow-auto">
                  ...
                  <TableBody>
                    {leaderboardData.map((entry) => (
                      <TableRow
                        ...
                        <TableCell className="font-bold text-auburn">{entry.rank}.</TableCell>
